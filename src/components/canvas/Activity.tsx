...
export default function Activity() {
  ...
  return (
    <Container flexShrink={1} flexDirection="column" width="100%" marginTop={12} padding={20} overflow="scroll">
      <Text fontSize={30} color={colors.primary12} marginBottom={4} id="title" index={0}>
        Activity
      </Text>
...
function Item({icon, label, date, ...props}: ItemProps) {
  ...
  return (
    <Container {...props} flexDirection="row" alignItems="center" padding={3} translateZ={isHovered ? 40: 0 }>
      <Container height={40} width={40} alignItems="center" justifyContent="center" borderRadius={5} backgroundOpacity={1} backgroundColor={colors.primary}>
        <SVG url={icon} height={30} width={30} color={colors.primary12} />
      </Container>
      <Container marginLeft={15} flexShrink={1}>
        <Text fontSize={25} color={colors.primary12}>
          {label}
        </Text>
        <Text fontSize={25} color={colors.neutral11}>
          {format(date)}
        </Text>
      </Container>
    </Container>
