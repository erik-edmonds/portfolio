...
import { slideAtom } from "@/components/canvas/Overlay";
import { Scene } from "@/components/canvas/Slide";

import { Train } from "@/components/models/Train";
//import { Forest } from "@/components/models/Forest"; //Replacing temporarily with CatAnime
...
export const scenes = [
  {
    ...
    name: "Mushroom",
    description:
      "A random mushroom created with Blender"
  },
  {
    mainColor: "#c0ffe1",
    name: "Japanese Style town",
    description: "A Japanese style building, with a train animation."
  },
  {
    mainColor: "#ffdec0",
    name: "Stylized Anime Girl",
...
export const Slideshow = () => {
  ...
  return (
    <>
      ...
      <mesh
        key="1"
        position={[(viewport.width + slideDistance), 0, 0]}>
        <planeGeometry args={[viewport.width, viewport.height]} />
        <meshBasicMaterial toneMapped={false}>
          <RenderTexture attach="map">
          <Scene {...scenes[1]}>
      ...
      <mesh
        key="2"
        position={[2 * (viewport.width + slideDistance), 0, 0]}>
        <planeGeometry args={[viewport.width, viewport.height]} />
        <meshBasicMaterial toneMapped={false}>
          <RenderTexture attach="map">
          <Scene {...scenes[2]}>
