...
export function RobotLab(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/robot_lab.glb')
        ...
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              ...
              <group name="eyes_83" position={[-0.228, 4.076, 0.69]} rotation={[-Math.PI, 0, 0]}>
                <mesh
                  name="Object_165"
                  castShadow
                  receiveShadow
              ...
              <group name="eyes001_84" position={[0.144, 4.094, 0.733]} rotation={[-Math.PI, 0, 0]}>
                <mesh
                  name="Object_167"
                  castShadow
                  receiveShadow
...
useGLTF.preload('/models/robot_lab.glb')